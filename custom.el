(custom-set-variables
 ...
 '(package-selected-packages
   '(flycheck-google-cpplint format-all py-yapf bazel org-download org-gcal org-roam-server org-timeline org-pomodoro image-dired+ majapahit-theme modus-vivendi-theme kaolin-themes tao-theme logview auto-yasnippet powerthesaurus vterm shell-pop projectile org-time-budgets org-bullets ob-browser lsp-julia eglot-jl csv-mode csv ayu-theme))
